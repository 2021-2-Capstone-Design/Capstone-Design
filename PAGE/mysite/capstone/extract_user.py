...
# path = "capstone/videos/" + sys.argv[1] + ".mp4"  # 기존 영상
path = "record_videos/" + sys.argv[1] + "_record.mp4"  # 유저 영상

# saving_path = "capstone/original_coordinate/" + sys.argv[1] + ".txt"  # 기존 영상 관절 좌표
saving_path = "user_coordinate/" + sys.argv[1] + "_record.txt"  # 유저 영상 관절 좌표
