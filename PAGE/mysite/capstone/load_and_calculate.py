...
if len(arguments) == 2:
    ...
    dance_name = arguments[1]
    select_person = arguments[2]
    coordinates_video_path = 'original_coordinate/' + dance_name + '_' + select_person + '.txt'
    coordinates_user_path = 'user_coordinate/' + dance_name + '_record.txt'
    result_path = 'results/result_' + dance_name + '_' + select_person + '.txt'
else:
