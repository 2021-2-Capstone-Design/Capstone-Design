...
saving_video_path = './DAIN/extractsamples/user_webcam.mp4' # 녹화된 영상 저장 위치
video_path = './DAIN/sample_dance/test.mp4'
...
def save_video():
    ...
    while recap.isOpened():
        ret, frame = recap.read()
        # if ret:
        #     mpDraw.draw_landmarks(frame, ret.pose_landmarks, mpPose.POSE_CONNECTIONS)
        if (record_flag == 1):
            print("recording...")
            out.write(frame)
        else:
